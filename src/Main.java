...
//        NotUsed.serverUdp.main(new String[]{StringCollection.PORT.getText()});
//        NotUsed.clientUdp.main(new String[]{StringCollection.PETERIP.getText(), StringCollection.PORT.getText()});
